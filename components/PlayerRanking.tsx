        ...
        <thead>
          <tr className="bg-gray-900">
            {[
              ...
              { key: "matchesPlayed", label: "Matchs Joués (17)" },
              { key: "goalsPerMatch", label: "Moyenne Buts/Match" },
            ].map(({ key, label }) => (
              <th
                key={key}
          ...
          {filteredData.length > 0 ? (
            filteredData.map((player) => (
              ...
              >
                ...
                <td className="p-2">
                  {player.totalGoals} ({player.goalPercentage.toFixed(2)}%)
                </td>
                <td className="p-2">{player.matchesPlayed}</td>
                <td className="p-2">{player.goalsPerMatch.toFixed(2)}</td>
              </tr>
            ))
          ) : (
            <tr>
